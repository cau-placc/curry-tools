...
\item[\fbox{\code{list [--system] [--versions] [--csv]}}]
...
of a package is shown.
The option \code{--system} restricts the list to those packages
which are compatible with the current compiler (if it is
explicitly specified in the package).
